...
![ScreenShot](https://github.com/LeoNick1/ImagesForRepos/blob/main/Screenshot_3.png?raw=true)
Реализация окна торговца с использованием инвентарей персонажей.
Данная реализация создавалась в рамках выполнения тестового задания  
на позицию Unity-разработчика.

Проект выполен в версии Unity 2020.3.44f1.
...
PlayerBalanceWidget.cs - представление баланса игрока, получаемое через  
соответствующий контроллер из данных счета.
...
JsonSaver.cs - класс сериализации данных игры в JSON-формат.
